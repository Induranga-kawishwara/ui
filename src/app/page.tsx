  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#08090E] text-[#F1F5F9] selection:bg-[#818CF8]/30 selection:text-white">
      ...
      <section className="relative overflow-hidden pt-12 pb-16 sm:pt-24 sm:pb-28">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 sm:space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-white font-sans break-words leading-[1.15]">
              The Celestial React Framework for{' '}
              <span
                className="bg-gradient-to-r from-white via-[#CBD5E1] to-[#818CF8] bg-clip-text text-transparent block sm:inline"
                style={{
            ...
            <p className="max-w-2xl mx-auto text-sm sm:text-base md:text-lg text-[#94A3B8] leading-relaxed px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-2 w-full max-w-xs sm:max-w-none mx-auto">
            ...
            <Link
              ...
              className="w-full sm:w-auto px-6 py-3 rounded-xl font-bold text-sm bg-[#121625] text-white border border-[#23283B] hover:border-[#818CF8]/50 hover:bg-[#818CF8]/10 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2"
            >
          ...
          <div className="pt-2 flex justify-center max-w-full px-2">
            <div
              ...
              className="group inline-flex items-center justify-between gap-2 sm:gap-3 px-3 sm:px-4 py-2 rounded-xl border border-[#23283B] bg-[#0A0D17]/90 text-xs font-mono text-[#CBD5E1] hover:border-[#818CF8]/50 hover:bg-[#0E1220] transition-all cursor-pointer shadow-lg max-w-full overflow-hidden"
            >
              <Terminal className="w-3.5 h-3.5 text-[#818CF8] shrink-0" />
              <span className="truncate">npx @deneb-ui/create-template my-store</span>
              <button
                className="p-1 rounded text-[#94A3B8] group-hover:text-white transition-colors shrink-0"
                title="Copy command"
              >
                {copiedCli ? (
      ...
      <section className="relative max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 pb-16 sm:pb-24 w-full">
        <div className="rounded-2xl sm:rounded-3xl border border-[#23283B] bg-[#0A0D17] shadow-2xl overflow-hidden">
          {/* Header tab switcher */}
          <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-[#23283B] bg-[#0E111C]/80 flex-wrap gap-3">
            ...
            <div className="flex items-center gap-1 p-1 rounded-xl bg-[#08090E] border border-[#23283B] overflow-x-auto max-w-full">
              <button
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="p-5 sm:p-6 rounded-2xl border border-[#23283B] bg-[#0A0D17] space-y-3 hover:border-[#818CF8]/40 transition-all">
          ...
          <div className="p-5 sm:p-6 rounded-2xl border border-[#23283B] bg-[#0A0D17] space-y-3 hover:border-[#818CF8]/40 transition-all sm:col-span-2 lg:col-span-1">
            <div className="p-3 w-fit rounded-xl bg-[#818CF8]/10 text-[#818CF8] border border-[#818CF8]/20">
      ...
      {/* Footer */}
      <footer className="mt-auto border-t border-[#23283B] bg-[#06070B] py-8 sm:py-12">
