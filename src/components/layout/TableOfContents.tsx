...
export function TableOfContents({ items }: { items: TocItem[] }) {
  ...
  return (
    <>
      ...
      <div className="hidden xl:block w-[240px] xl:w-[260px] shrink-0 border-l border-[#23283B]/60 px-4 lg:px-5 py-6 text-xs sticky top-16 self-start h-[calc(100vh-4rem)] overflow-y-auto">
